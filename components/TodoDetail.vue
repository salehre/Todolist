<template>
  <div :class="[
    'rounded-2xl border border-primary-200/50 bg-linear-to-br from-white via-primary-50/40 to-primary-100/40 shadow-lg shadow-primary-200/40 backdrop-blur-sm flex flex-col h-full overflow-hidden',
