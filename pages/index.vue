  ...
  <div class="min-h-screen bg-primary-50 text-slate-800">
    ...
    <main>
      ...
      <section class="relative overflow-hidden px-5 pt-16 pb-20 sm:pt-24 sm:pb-28">
        ...
        ></div>
        <div class="pointer-events-none absolute -top-24 -inset-e-24 h-72 w-72 rounded-full bg-primary-300/40 blur-3xl"></div>
        <div class="pointer-events-none absolute -bottom-24 -inset-s-24 h-72 w-72 rounded-full bg-primary-200/50 blur-3xl"></div>
